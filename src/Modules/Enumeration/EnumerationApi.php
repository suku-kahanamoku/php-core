...
class EnumerationApi
{
    ...
    {
        $this->_service = new EnumerationService($db, $franchiseCode, $auth);
    }
    ...
    {
        Response::success($this->_service->types());
    }
    ...
    {
        $item = $this->_service->update((int) $params['id'], [
